...
const LogIn = () => {
    return (
        ...
        <div>
            ...
            <div className='mt-6 '>
             <input className='block ml-2 lg:ml-3  py-1 px-1 lg:px-2 mb-2' type="text" placeholder='Enter your email address' />
            <input className='block ml-2 lg:ml-3 py-1 px-1 lg:px-2' type="password" placeholder='Enter your valid password' />
            </div>
