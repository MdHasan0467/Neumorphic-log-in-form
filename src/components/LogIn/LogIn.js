...
const LogIn = () => {
    return (
        <div className='form ml-[20%] lg:ml-[40%] mt-[5%] w-[220px] py-5 rounded-lg'>
            ...
            <img className='w-[50px] h-[50px] rounded-full ml-[35%] mt-5' src="https://cdn5.vectorstock.com/i/thumb-large/90/99/black-thin-line-sign-up-with-hand-vector-28279099.jpg" alt="" />
            <div className='mt-6 '>
